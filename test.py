...
try:
    ...
    driver = return_my_driver(29543, '/Users/mac/Desktop/desktop/scanner/chromedriver/chromedriver-127')
    # driver = driver = open_profile_by_id('66fb0b1bea246fda1192030a', '/Users/mac/Desktop/desktop/scanner/chromedriver/chromedriver-127')['driver']
